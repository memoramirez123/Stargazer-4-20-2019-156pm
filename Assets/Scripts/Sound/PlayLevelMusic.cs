...
public class PlayLevelMusic : MonoBehaviour {
	...
	string DetectSeasonChange(){
        ...
        {
            return "MainMenu";
        }else if(newLevelIndex == 1 || newLevelIndex == 2 || newLevelIndex == 3 || newLevelIndex == 4)
        {
            return "spring";
        }
        else if (newLevelIndex == 5 || newLevelIndex == 6 || newLevelIndex == 7 || newLevelIndex == 8)
        {
            return "summer";
        }
        else if (newLevelIndex == 9 || newLevelIndex == 10 || newLevelIndex == 11 || newLevelIndex == 12)
        {
            return "fall";
        }
        else if (newLevelIndex == 13 || newLevelIndex == 14 || newLevelIndex == 15 || newLevelIndex == 16)
        {
            return "winter";
        }
        else
